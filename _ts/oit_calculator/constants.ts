...
export const DEFAULT_CONFIG: ProtocolConfig = {
	...
	SOLID_MIX_CANDIDATES: [
		0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.3, 1.5, 1.7,
		2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 9, 10, 12, 14, 16, 18, 20, 25, 30,
	].map((num) => new Decimal(num)),
	...
	DAILY_AMOUNT_CANDIDATES: [
		0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 6, 7, 8, 9, 10, 11, 12, 14, 16, 18,
		20,
	].map((num) => new Decimal(num)),
};
