...
describe('Utils', () => {
  ...
  describe('parseSafeDecimal', () => {
    it('should parse valid strings', () => {
      expect(utils.parseSafeDecimal('10.5', new Decimal(0)).toNumber()).toBe(10.5);
    });
    ...
    it('should clamp to minimum value', () => {
      expect(utils.parseSafeDecimal('5', new Decimal(10), 10).toNumber()).toBe(10);
      expect(utils.parseSafeDecimal('15', new Decimal(0), 10).toNumber()).toBe(15);
    });
  });
  ...
  describe('serializeProtocol', () => {
    const foodA: Food = {
      ...
      getMgPerUnit() { return new Decimal(32); }
    };
    ...
    const foodB: Food = {
      ...
      getMgPerUnit() { return new Decimal(250); }
    };
    ...
    it('should handle protocol without Food B', () => {
      const simpleProtocol = { ...protocol, foodB: undefined, foodBThreshold: undefined, steps: protocol.steps.slice(0, 2) };
