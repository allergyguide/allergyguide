...
import { FoodType, type SearchResult, type FoodData, type ProtocolData } from "../types";
...
export function performSearch(
  ...
  if (searchType === "food") {
    ...
    const combined: SearchResult[] = [
      ...protocolResults.map(r => ({ type: "protocol" as const, data: r.obj as ProtocolData })),
      ...foodResults.map(r => ({ type: "food" as const, data: r.obj as FoodData }))
    ];
