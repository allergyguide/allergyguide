		...
		iconEl.addEventListener("click", function () {
			...
			citationKeys.forEach(function (citationKey) {
				...
				if (ref) {
					...
					popupContent +=
						'<p class="ref-text"><a class="ref-link" href="' +
						referenceUrl +
						'" target="_blank">' +
						formattedCitation +
						"</a></p>";
					...
					if (ref.tags.abstract && ref.tags.abstract.trim() !== "") {
						...
						popupContent +=
							'<p class="ref-notes" style="font-size:0.8rem">' +
							abstract +
							"</p>";
					}
