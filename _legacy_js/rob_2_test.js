...
function testTraverseTree1() {
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q1_1: "Yes", q1_2: "Yes", q1_3: "No" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q1_1: "Yes", q1_2: "Yes", q1_3: "Yes" }),
		),
		"Some concerns",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q1_1: "No", q1_2: "No", q1_3: "Yes" }),
		),
		"High risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q1_1: "Yes", q1_2: "No", q1_3: "No" }),
		),
		"High risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q1_1: "No", q1_2: "Yes", q1_3: "No" }),
		),
		"Some concerns",
...
function testTraverseTree3() {
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q3_1: "Yes", q3_2: "NA", q3_3: "NA", q3_4: "NA" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q3_1: "No", q3_2: "Yes", q3_3: "NA", q3_4: "NA" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q3_1: "No", q3_2: "No", q3_3: "No", q3_4: "No" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q3_1: "No", q3_2: "No", q3_3: "No", q3_4: "Yes" }),
		),
		"Low risk",
		"Test Case 6: low",
	);
...
function testTraverseTree4() {
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q4_1: "No", q4_2: "No", q4_3: "No" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q4_1: "No", q4_2: "No", q4_3: "Prob No" }),
		),
		"Low risk",
...
function testTraverseTree5() {
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Yes", q5_2: "No", q5_3: "No" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Prob Yes", q5_2: "No", q5_3: "No" }),
		),
		"Low risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "No info", q5_2: "No", q5_3: "No" }),
		),
		"Some concerns",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "No", q5_2: "No", q5_3: "No" }),
		),
		"Some concerns",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Yes", q5_2: "Yes", q5_3: "No" }),
		),
		"High risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Yes", q5_2: "No", q5_3: "Yes" }),
		),
		"High risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Prob Yes", q5_2: "Yes", q5_3: "No" }),
		),
		"High risk",
	...
	assertEqual(
		traverseTree(
			tree,
			mockGetDomainAnswers({ q5_1: "Prob Yes", q5_2: "No", q5_3: "Yes" }),
		),
		"High risk",
