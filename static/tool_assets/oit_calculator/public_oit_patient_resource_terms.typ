...
#let physician-review-sheet(
  ...
  align(center)[
    #text(size: 10pt, fill: gray)[
      ...
      This document was created using an open-source calculation tool. You should review available literature and local OIT guidelines, and decide if this protocol is applicable to your practice. This tool does not exercise clinical judgment. Use of this document without direct physician supervision is strictly prohibited.
    ]
  ]
}
