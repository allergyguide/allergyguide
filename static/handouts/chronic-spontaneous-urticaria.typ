...
in many people, it is due to an autoimmune process (this is where the body produces antibodies, which normally helps fight infections, but are now triggering your allergy cells to release histamine, which causing the hives and swelling)
...
The condition is self-limiting and will subside within months to years.

== What can make my hives/angioedema worse?
Although this is not a food/medication allergy, hives and swelling can be flared by alcohol, NSAIDs (anti-inflammatory drugs like Advil, Motrin, ibuprofen, naproxen, Anaprox, Voltaren, diclofenac...) and therefore these should be avoided. Stress can also exacerbate the hives.
...
#v(1em)
#align(center)[
  *If antihistamines are not effective, then your doctor can discuss other options.*
]
